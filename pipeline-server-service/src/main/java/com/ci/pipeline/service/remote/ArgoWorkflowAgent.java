...
public interface ArgoWorkflowAgent {
     ...
     */
    IoArgoprojWorkflowV1alpha1WorkflowTemplate lintWorkflowTemplate(String namespace,
     ...
     */
    IoArgoprojWorkflowV1alpha1WorkflowTemplate createWorkflowTemplate(String namespace,
                                                                       IoArgoprojWorkflowV1alpha1WorkflowTemplate workflowTemplate);
     ...
     */
    IoArgoprojWorkflowV1alpha1WorkflowTemplate updateWorkflowTemplate(String namespace,
                                                                      String name,
                                                                      IoArgoprojWorkflowV1alpha1WorkflowTemplate workflowTemplate);
     ...
     * @param name      模板名称
     */
    void deleteWorkflowTemplate(String namespace, String name);

    /**
     * 保存 WorkflowTemplate：先按名称查询是否已存在，存在则更新，不存在则创建（统一入口）。
     * <p>
     * 注意：{@link #getWorkflowTemplate(String, String)} 在模板不存在时会抛出异常，
     * 本方法据此判定走创建还是更新。
     *
     * @param namespace        命名空间
     ...
     */
    IoArgoprojWorkflowV1alpha1WorkflowTemplate saveWorkflowTemplate(String namespace,
                                                                    IoArgoprojWorkflowV1alpha1WorkflowTemplate workflowTemplate);
     ...
     */
    IoArgoprojWorkflowV1alpha1WorkflowTemplate getWorkflowTemplate(String namespace, String name);
     ...
     */
    IoArgoprojWorkflowV1alpha1Workflow submitWorkflow(String namespace,
     ...
     * @return 提交后的 Workflow
     */
    IoArgoprojWorkflowV1alpha1Workflow submitWorkflowByTemplate(String namespace,
                                                                String templateName,
                                                                List<String> parameters);
     ...
     * @return Workflow 实例
     */
    IoArgoprojWorkflowV1alpha1Workflow getWorkflow(String namespace, String name);
     ...
     */
    IoArgoprojWorkflowV1alpha1WorkflowList listWorkflows(String namespace, List<String> phases);
     ...
     */
    IoArgoprojWorkflowV1alpha1Workflow retryWorkflow(String namespace, String name);
     ...
     */
    IoArgoprojWorkflowV1alpha1Workflow stopWorkflow(String namespace, String name);
     ...
     */
    IoArgoprojWorkflowV1alpha1Workflow terminateWorkflow(String namespace, String name);
     ...
     */
    IoArgoprojWorkflowV1alpha1Workflow resumeWorkflow(String namespace, String name);
     ...
     */
    IoArgoprojWorkflowV1alpha1Workflow suspendWorkflow(String namespace, String name);
     ...
     * @param name      Workflow 名称
     */
    void deleteWorkflow(String namespace, String name);
}
